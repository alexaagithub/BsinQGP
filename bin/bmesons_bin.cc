...
void pT_analysis(RooWorkspace& w, int n, TString ptfile, TString datafile){
  ...
  TString dir_name = particle ? "./results_new/Bs/Bpt/" : "./results_new/Bu/Bpt/";
  ...
  */
  ...
  for(int i=0;i<n_pt_bins;i++){
    ...
    massframe->Draw();
    if(particle == 0){
      b.SaveAs(Form("./results_new/Bu/Bpt/%lf_%lf_fit_plot_Bu.gif", pt_bins[i], pt_bins[i+1]));
      b.SaveAs(Form("./results_new/Bu/Bpt/%lf_%lf_fit_plot_Bu.pdf", pt_bins[i], pt_bins[i+1]));
    }else if(particle == 1){
      b.SaveAs(Form("./results_new/Bs/Bpt/%lf_%lf_fit_plot_Bs.gif", pt_bins[i], pt_bins[i+1]));
      b.SaveAs(Form("./results_new/Bs/Bpt/%lf_%lf_fit_plot_Bs.pdf", pt_bins[i], pt_bins[i+1]));
    }
  ...
  if(particle == 0){
    c.SaveAs("./results_new/Bu/Bpt/raw_yield_pt_Bu.pdf");
    c.SaveAs("./results_new/Bu/Bpt/raw_yield_pt_Bu.gif");}
  else if(particle == 1){
    c.SaveAs("./results_new/Bs/Bpt/raw_yield_pt_Bs.pdf");
    c.SaveAs("./results_new/Bs/Bpt/raw_yield_pt_Bs.gif");}
...
void get_ratio( std::vector<TH1D*> data, std::vector<TH1D*> mc,  std::vector<TString> v_name, TString filename) {
  ...
  TString dir_name = particle ? "./results_new/Bs/mc_validation_plots/weights/" : "./results_new/Bu/mc_validation_plots/weights/";
...
void plot_complete_fit(RooWorkspace& w){
  ...
  if(DATA_CUT == 0){
    if(particle == 0){
      d.SaveAs("./results_new/Bu/complete_fit_Bu.pdf");
      d.SaveAs("./results_new/Bu/complete_fit_Bu.gif");
    }else if(particle == 1){
      d.SaveAs("./results_new/Bs/complete_fit_Bs.pdf");
      d.SaveAs("./results_new/Bs/complete_fit_Bs.gif");
    }
  }
}
...
TH1D* create_histogram(RooRealVar var,TString name, double factor, RooDataSet* reduced, RooDataSet* central, RooDataSet* total, int n){
  ...
  if(particle == 0){
    c.SaveAs("./results_new/Bu/sideband_sub/"+name + "sideband_sub_Bu.pdf");
    c.SaveAs("./results_new/Bu/sideband_sub/"+name + "sideband_sub_Bu.gif");
  }else if(particle == 1){
    c.SaveAs("./results_new/Bs/sideband_sub/"+name + "sideband_sub_Bs.pdf");
    c.SaveAs("./results_new/Bs/sideband_sub/"+name + "sideband_sub_Bs.gif");
  }
...
TH1D* make_splot(RooWorkspace& w, int n, TString label){
  ...
  if(particle == 0){
    cdata->SaveAs("./results_new/Bu/splot/Bmass/"+label+"sPlot_Bu.gif");
    cdata->SaveAs("./results_new/Bu/splot/Bmass/"+label+"sPlot_Bu.pdf");
  }else if(particle == 1){
    cdata->SaveAs("./results_new/Bs/splot/Bmass/"+label+"sPlot_Bs.gif");
    cdata->SaveAs("./results_new/Bs/splot/Bmass/"+label+"sPlot_Bs.pdf");
  }
  ...
  if(particle == 0){
    prov->SaveAs("./results_new/Bu/splot/sig/"+label+"sPlot_Bu.gif");
    prov->SaveAs("./results_new/Bu/splot/sig/"+label+"sPlot_Bu.pdf");
  }else if(particle == 1){
    prov->SaveAs("./results_new/Bs/splot/sig/"+label+"sPlot_Bs.gif");
    prov->SaveAs("./results_new/Bs/splot/sig/"+label+"sPlot_Bs.pdf");
  }
  ...
  if(particle == 0){
    prov_bkg->SaveAs("./results_new/Bu/splot/bkg/"+label+"sPlot_Bu.gif");
    prov_bkg->SaveAs("./results_new/Bu/splot/bkg/"+label+"sPlot_Bu.pdf");
  }else if(particle == 1){
    prov_bkg->SaveAs("./results_new/Bs/splot/bkg/"+label+"sPlot_Bs.gif");
    prov_bkg->SaveAs("./results_new/Bs/splot/bkg/"+label+"sPlot_Bs.pdf");
  }
  ...
  if(particle == 0){
    sig_bkg->SaveAs("./results_new/Bu/splot/sig_bkg/"+label+"sPlot_Bu.gif");
    sig_bkg->SaveAs("./results_new/Bu/splot/sig_bkg/"+label+"sPlot_Bu.pdf");
  }else if(particle == 1){
    sig_bkg->SaveAs("./results_new/Bs/splot/sig_bkg/"+label+"sPlot_Bs.gif");
    sig_bkg->SaveAs("./results_new/Bs/splot/sig_bkg/"+label+"sPlot_Bs.pdf");
  }
...
void validate_fit(RooWorkspace* w)
{
  ...
  if(particle == 0){
    c_pull->SaveAs("./results_new/Bu/pulls/pulls_poisson_Bu.pdf");
    c_pull->SaveAs("./results_new/Bu/pulls/pulls_poisson_Bu.gif");
    c_params->SaveAs("./results_new/Bu/pulls/pulls_params_poisson_Bu.pdf");
    c_params->SaveAs("./results_new/Bu/pulls/pulls_params_poisson_Bu.gif");
  }else if(particle == 1){
    c_pull->SaveAs("./results_new/Bs/pulls/pulls_poisson_Bs.pdf");
    c_pull->SaveAs("./results_new/Bs/pulls/pulls_poisson_Bs.gif");
    c_params->SaveAs("./results_new/Bs/pulls/pulls_params_poisson_Bs.pdf");
    c_params->SaveAs("./results_new/Bs/pulls/pulls_params_poisson_Bs.gif");
  }
