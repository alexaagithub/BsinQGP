  ...
  */
  ...
  for(int i=0;i<n_pt_bins;i++){
    ...
    for(int k = 0; k<n_pdf_syst; k++){
      ...
      cout << "bin:" << i << " range bin min" << pt_bins[i] << " src:" << k << " syst:" << syst_src[k] << " yield syst:" << yield_syst[i][k]<< " rel:"<<  ((val - val_nominal)/val_nominal)*100 << "\%" << "variacao: " << val <<endl;
    }  
   ...
   RooRealVar* mean  = w.var("mean");
    ...
    cout<<"xxxy pt: "<< pt_bins[i]<<"-" << pt_bins[i+1] << " mean_weight:"<< 0 << "  Nsig:" <<yield[i]<< "-"<<yield_err_low[i] <<"+" << yield_err_high[i]<<endl;
    ...
    cout<<"xxx pt: "<< pt_bins[i]<<"-" << pt_bins[i+1] << " mean_weight:"<< 0 << "  Nsig:" <<yield[i]<< "-"<<yield_err_low[i] <<"+" << yield_err_high[i]<<endl;
